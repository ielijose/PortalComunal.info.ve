        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h3><strong>Editar</strong> Portal</h3>
                            <p>Completa el siguiente formulario:</p>
                            <!-- BEGIN FORM WIZARD WITH VALIDATION -->
                            <form class="form-wizard" action="/editar-portal" method="POST">
                                <h1>Datos básicos</h1>
                                <section>
                                    <div class="form-group col-md-12">
                                        <label for="consejo_comunal">Consejo comunal *</label>
                                        <input id="consejo_comunal" name="consejo_comunal" type="text" class="form-control required" placeholder="" value="{{ $portal->consejo_comunal }}">
                                    </div>

                                    <div class="form-group col-md-12">
                                        <label for="direccion">Dirección *</label>
                                        <input id="direccion" name="direccion" type="text" class="form-control required" value="{{ $portal->direccion }}">
                                    </div>   
